...
# ===========================================================================
# dev.sh — Start the development stack (Deno API + backing services)
#
# Usage:
...
# each needing its own port.
#
# This is the headless MCP-server template — no Vite SPA, no web/ directory.
# The API (and MCP server at /api/mcp) is the entire surface.
# ===========================================================================
